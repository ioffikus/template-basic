// WIP fork of polyfill.number.toLocaleDateString (added locales ru-RU, lv-LV, pl-PL, remove test of toLocaleStringSupportsLocales)
/*jshint sub:true*/
...
(function() {
  ...
  var test = false; // toLocaleStringSupportsLocales();
  ...
  if (!test) {
    ...
    var transformForLocale = {
      ...
      lv: dotThousCommaDec,
      'lv-LV': dotThousCommaDec,
      nl: dotThousCommaDec,
      'nl-BE': dotThousCommaDec,
      'nl-NL': dotThousCommaDec,
      pl: dotThousCommaDec,
      'pl-PL': dotThousCommaDec,
      ru: dotThousCommaDec,
      'ru-RU': dotThousCommaDec,
      ro: dotThousCommaDec,
